...
SECRET_KEY = 'django-insecure-86^0goh+g0(qan*po8w#m2s0*&h=z2ttfyrig@e8v&vsun=qj9'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Optional: For your custom static files during development
]
